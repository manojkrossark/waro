  ...
  return (
    <div className="dashboard-body">
      <div className="position-relative">
        <DashboardHeaderTwo title="Schedule for Delivery" />

        <div className="row gx-0 align-items-center">
          <MailOffcanvas />
          <div className="col-lg-4">
            <div className="d-flex align-items-center justify-content-between">
              <h2 className="main-title d-block d-lg-none m0">
              ...
              <div className="message-sidebar pt-20">
                <div className="ps-3 pe-3 ps-xxl-4 pe-xxl-4">
                  ...
                  <form
                    ...
                    className="search-form mt-20 mb-20"
                  >
                    <input type="text" placeholder="Search contacts" />
                    <button>
                      <Image src={icon_3} alt="" className="lazy-img m-auto" />
                    </button>
                  </form> */}
