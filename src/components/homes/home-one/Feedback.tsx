...
const feedback_data: DataType[] = [
   {
      ...
      country: "Milan, Itlay",
      desc: "Efficient and intelligent, this solution makes retail operations seamless with predictive inventory management and personalized customer experiences—highly recommended!",
      rating_count: 4.7,
      total_rating: 13,
   },
   {
