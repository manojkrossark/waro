      ...
      <div className="block-feature-one mt-130 xl-mt-100 lg-mt-80 mb-150 xl-mb-100 lg-mb-80">
         <div className="container">
            <div className="title-one text-center mb-50 xl-mb-30 lg-mb-20 wow fadeInUp">
               <h3>Unlock Alto&apos;s <span>advantages <Image src={titleShape} alt="" className="lazy-img" /></span></h3>
               <p className="fs-35">Your trusted partner in every transaction, ensuring seamless operations and personalized customer experiences.</p>
            </div>
