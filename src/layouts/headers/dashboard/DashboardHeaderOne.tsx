  ...
  return (
    <aside className={`dash-aside-navbar ${isActive ? "show" : ""}`}>
      <div className="position-relative">
        <div className="logo d-md-block d-flex align-items-center justify-content-between plr bottom-line pb-30 pt-20">
          ...
          <ul className="style-none">
            ...
            <li className="plr">
              <Link
                ...
                className={`d-flex w-100 align-items-center ${
                  pathname === "/dashboard/inventory" ? "active" : ""
                }`}
              >
                <Image
                  src={
                  ...
                  alt=""
                />
                <span>Inventory / Stock Allocation</span>
              </Link>
            </li>
            <li className="plr">
              <Link
