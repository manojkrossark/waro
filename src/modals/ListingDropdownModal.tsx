                                    ...
                                    <div className="col-md-6">
                                       <div className="input-box-one mb-35">
                                          ...
                                          <NiceSelect className="nice-select fw-normal"
                                             options={[
                                                { value: "Smart AI", text: "Location Intelligence" },
                                                { value: "Smart AI", text: "Demand Forecast" },
                                                { value: "Smart AI", text: "Customer Journey" },
                                                { value: "Smart AI", text: "Sustainable Product Recommendations" },
                                             ]}
                                             defaultCurrent={0}
