...
import featureIcon_1 from "@/assets/images/icon/icon_09.svg";
import featureIcon_2 from "@/assets/images/icon/icon_07.svg";
...
const feature_data: DataType[] = [
   {
      ...
      btn:"Location Intelligence",
      desc: "Uses geospatial analytics to recommend optimal store locations based on customer demand and competition.",
   },
   {
      id: 2,
      page: "home_1_feature_1",
      ...
      btn:"Demand Forecast",
      desc: "Discover a product you'll love with our demand forecasting solution, leveraging 35+ data filters and tailored insights for optimal inventory management",
   },
   {
      id: 3,
      page: "home_1_feature_1",
      ...
      desc: "List, sell, and thrive with our intelligent solution that automatically adjusts inventory based on predictive analytics and real-time sales data—making the process easy and enjoyable!",
   },
