...
const dropdoun_data: InputField[] = [
   {
      ...
      options: [{ value: "1", text: "Location Intelligence" }, { value: "2", text: "Rent Condos" }, { value: "3", text: "Sell Houses" }, { value: "4", text: "Sell Houses" }, { value: "5", text: "Rent Industrial" }, { value: "6", text: "Sell Villas" },],
   },
   {
      id: 2,
      page: "home_1",
